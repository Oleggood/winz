<template>
    <div class="mb60">
        ...
        <div class="flex">
            <div class="col6 col12-768" v-if="event['before_start']['invert']">
                <div class="card-border form-width">
                    ...
                    <div class="mb20">
                        <div class="mb10">
                            <block-checkbox :label="'Уведомить участников'"
                                            v-model="form['notify']">
                            </block-checkbox>
                        </div>
                        <block-input :label="'Причина (будет отправлена участникам)'"
...
export default {
    ...
    data() {
        return {
            ...
            urlSaveStatus: route('back.events.cancel'),
        }
    },
    methods: {
        saveStatus() {
