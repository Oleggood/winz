...
return [
    ...
    'url' => 'Скопируйте URL из адресной строки полностью (http://...).',
    ...
    'attributes' => [
        ...
        'username' => 'Никнейм',
        'year' => 'Год',
        'description1' => 'Краткое описание',
        'surface' => 'Тип местности',
        'difficult' => 'Уровень сложности',
        'longs' => 'Продолжительность',
        'escort' => 'Сопровождение',
        'site_link' => 'Ссылка на сайт',
        'specialization' => 'Специализация',
        'code' => 'Код огранизации',
        'blog_link' => 'Ссылка на блог',
        'video_link' => 'Ссылка на портфолио',
        'start' => 'Дата и время начала',
        'type' => 'Тип события',
        'features' => 'Особенности',
        'length_unit' => 'Дней/Часов',
        'length_count' => 'Продолжительность',
        'transports' => 'Транспорт',
        'targets' => 'Цели',
        'transport_provided' => 'Предоставление транспорта',
        'transport_requirements' => 'Требования к ТС',
        'min_participant' => ' ',
        'opt_participant' => ' ',
        'max_participant' => ' ',
        'min_team' => ' ',
        ...
        'food' => 'Питание',
        'lodging' => 'Проживание',
        'min_preparation' => 'Мин.уровень',
        'equipment_requirements' => 'Требования к экипировке',
        'other_requirements' => 'Иные требования',
        'payment' => 'Стоимость участия',
        'currency' => 'Валюта',
        'payment_requirements' => 'Порядок оплаты взноса',
        'transfer' => 'Трансфер',
        'role' => 'Роль',
        'passengers' => 'Пассажиры',
        'rating_travel' => 'Оценка маршрута',
        'rating_event' => 'Оценка события',
        'rating_user' => 'Оценка организатора события',
        'review' => 'Отзыв',
        'text' => 'Текст',
    ],
];
